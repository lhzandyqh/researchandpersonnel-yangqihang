<template>
  <div class="app-container">
    <div v-if="roles==='教师'" id="bar_dv" ref="chart">
...
<!--&lt;!&ndash;                      <el-option label="文学院" value="1"></el-option>&ndash;&gt;-->
<!--&lt;!&ndash;                      <el-option label="理学院" value="2"></el-option>&ndash;&gt;-->
<!--&lt;!&ndash;                      <el-option label="教育学院" value="3"></el-option>&ndash;&gt;-->
<!--&lt;!&ndash;                      <el-option label="医学院" value="4"></el-option>&ndash;&gt;-->
<!--&lt;!&ndash;                      <el-option label="商学院" value="5"></el-option>&ndash;&gt;-->
<!--&lt;!&ndash;                      <el-option label="管理学院" value="6"></el-option>&ndash;&gt;-->
<!--&lt;!&ndash;                      <el-option label="机械工程学院" value="7"></el-option>&ndash;&gt;-->
<!--&lt;!&ndash;                      <el-option label="电子信息学院" value="8"></el-option>&ndash;&gt;-->
<!--&lt;!&ndash;                      <el-option label="电气工程学院" value="9"></el-option>&ndash;&gt;-->
<!--                    </el-select>-->
<!--                  </div>-->
<!--&lt;!&ndash;                  <div style="font-size: 14px;margin: 0 15px;font-weight: bolder">请选择类型:</div>&ndash;&gt;-->
<!--&lt;!&ndash;                  <div>&ndash;&gt;-->
<!--&lt;!&ndash;                    <el-select v-model="value2" multiple  placeholder="请选择类型">&ndash;&gt;-->
<!--&lt;!&ndash;                      <el-option label="项目申请" value="项目申请"></el-option>&ndash;&gt;-->
<!--&lt;!&ndash;                      <el-option label="科研项目" value="科研项目"></el-option>&ndash;&gt;-->
<!--&lt;!&ndash;                      <el-option label="学术论文" value="学术论文"></el-option>&ndash;&gt;-->
<!--&lt;!&ndash;                      <el-option label="专利登记" value="专利登记"></el-option>&ndash;&gt;-->
<!--&lt;!&ndash;                      <el-option label="专著登记" value="专著登记"></el-option>&ndash;&gt;-->
<!--&lt;!&ndash;                    </el-select>&ndash;&gt;-->
<!--&lt;!&ndash;                  </div>&ndash;&gt;-->
<!--&lt;!&ndash;                  <div style="font-size: 14px;margin: 0 15px;font-weight: bolder">请选择指标:</div>&ndash;&gt;-->
<!--&lt;!&ndash;                  <div>&ndash;&gt;-->
<!--&lt;!&ndash;                    <el-select v-model="value3" multiple  placeholder="请选择指标">&ndash;&gt;-->
<!--&lt;!&ndash;                      <el-option label="总数" value="1"></el-option>&ndash;&gt;-->
<!--&lt;!&ndash;                      <el-option label="平均数" value="2"></el-option>&ndash;&gt;-->
<!--&lt;!&ndash;                    </el-select>&ndash;&gt;-->
<!--&lt;!&ndash;                  </div>&ndash;&gt;-->
<!--                  <div>-->
...
import chartEleven from '@/views/customInterface/homePage/echart/chart_eleven'
...
export default {
  ...
  mounted() {
    //console.log("当前role",this.$store.getters.roles)
    // this.initChart()
    // this.somePaperSum()
    this.getBasic(this.$store.getters.roles[0])
  },
  methods: {
    initChart: function() {
